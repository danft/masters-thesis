...
\begin{frame}{Transforming the problem}
	...
	\begin{figure}
		...
		\caption{After scaling by $\frac{b}{a}$.}
		\label{fig:sol33}
	\end{figure}
\end{frame}
...
\begin{frame}{Transforming the problem}
	...
	\begin{figure}
		\centering
		%\caption{Transforming an ellipse into a circle. T1, T2, and T3 represent the steps of the transformation.}
		\includegraphics[scale=.5]{sol31}
		\caption{After scaling by $\frac{a}{b}$.}
...
\begin{frame}{Transforming the problem}
	...
	\begin{figure}
		...
		\caption{A solution is obtained after scaling by $\frac{a}{b}$ and rotating by $-\theta$.}
		\label{fig:sol4}
	\end{figure}
\end{frame}
...
We define the function $\xi : [0, \pi) \mapsto \R$:
	...
	\begin{itemize}
		...
		$$\sum_{0 \le j, k \le Deg(\xi)} \alpha_{j,k}\cos^{j}{\theta}\sin^{k}{\theta}.$$
