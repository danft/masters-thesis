...
--(axis cs:0.2,-0.2);
\draw[draw=red,fill opacity=0] (axis cs:-0.8,-0.2) circle (1);
\draw[draw=green!50.19607843137255!black,fill opacity=0] (axis cs:-0.2,0.4) circle (1);
\draw[draw=blue,fill opacity=0] (axis cs:0.9,-0.4) circle (1);
\end{axis}
