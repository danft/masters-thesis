In this chapter, the version of the Planar Maximal Covering by Ellipses Problem where every ellipse has to be parallel to the coordinate axis will be introduced and a method for it will be developed.
