...
I n the next section we present the results of numerical experiments for MCER and MCER-$k$ and compare them with the results published in \citeonline{andreta}.