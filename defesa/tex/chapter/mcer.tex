...
Firstly, we describe an algorithm that returns a CLS for an ellipse given a demand set. 
...
In our implementation we use a tree-like data structure to verify if a  that is also used in \citeonline{andreta}.
