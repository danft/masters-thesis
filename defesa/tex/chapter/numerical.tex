	...
	\begin{center}
		\resizebox{\textwidth}{!}{%
			...
			\begin{tabular}{|cccc|cr|crrrr|}
				...
				\multirow{2}{*}{Income} & 
				Max CLS&
				\multicolumn{2}{c}{Backtrack Tree} & 
				\multicolumn{2}{c|}{\centering CPU Time (s)}\\
				& & & & \centering Ellipses & & size & \# nodes & \# sol. leaves & CLS-MCE & Total\\
				\hline
...
\begin{table}\label{tab:mce-results-ab1}
	\begin{center}
		\resizebox{0.85\textwidth}{!}{%
			
			\begin{tabular}{|cccc|cr|rrrrr|}
				\hline
				\multicolumn{4}{|c|}{Instance} & \multicolumn{2}{c|}{Optimal Solution} & \multicolumn{5}{c|}{Performance metrics}\\
				\hline
...
\begin{table}\label{tab:mce-results-ab2}
	\begin{center}
		\resizebox{0.85\textwidth}{!}{%
...
\begin{table}\label{tab:mcer-results-cm}
	\begin{center}
		\resizebox{\textwidth}{!}{%
			
			\begin{tabular}{|cccc|cr|rrrrrr|}
				\hline
				...
				\multicolumn{2}{c}{backtrack tree} & 
				\multicolumn{2}{c|}{\centering CPU Time (s)}\\
				& & & & \centering Ellipses & & size & subproblems & \# nodes & \#sol leaves & CLS-MCER & Total\\
...
\begin{table}\label{tab:mcer-results-ab1}
	\begin{center}
		\resizebox{\textwidth}{!}{%
...
\begin{table}\label{tab:mcer-results-ab2}
	\begin{center}
		\resizebox{\textwidth}{!}{%
