...
\begin{frame}{Maximum Weight Clique Problem}
	\begin{figure}
		\only<1>{\caption{An instance of $MCD(\Pp, 1)$.}}
		...
		\only<1>{\includegraphics[scale=0.55]{figures/mwc_1.pdf}}
		\only<2>{\includegraphics[scale=0.55]{figures/mwc_2.pdf}}
		\only<3>{\includegraphics[scale=0.55]{figures/mwc_3.pdf}}
